...
const ProfileCardComponent = ({
  ...
  const handlePointerMove = useCallback(event => {
    ...
    tiltEngine.setTarget(...Object.values(getOffsets(event, shell)));
  }, [tiltEngine]);
  ...
  useEffect(() => {
    ...
    tiltEngine.setImmediate(shell.clientWidth - ANIMATION_CONFIG.INITIAL_X_OFFSET, ANIMATION_CONFIG.INITIAL_Y_OFFSET);
    tiltEngine.toCenter();
  ...
  const cardStyle = useMemo(() => ({
    ...
    '--behind-glow-color': behindGlowColor ?? 'rgba(0, 240, 192, 0.45)',
